...
<p align="center">
  <img src="assets/img/codex_setting.png" alt="Codex provider" width="620">
</p>
...
<p align="center">
  <img src="assets/img/chatgpt_web_setting.png" alt="ChatGPT Web provider" width="620">
</p>
...
脚本会打开一个命令行窗口，并自动执行安装辅助步骤，安装脚本会自动检查以下内容：

- 是否安装了 Node.js (如果电脑没有 Node.js, 安装界面会提示请先安装：
  https://nodejs.org/ 安装 Node.js 后，关闭当前安装窗口，再重新双击 `install.bat`)
- 是否安装了 Codex CLI
...
由于这是预览测试版，不是 Chrome Web Store 商店版本，所以需要手动加载一次。
...
<p align="center">
  <img src="assets/img/chrome_extension.png" alt="Chrome 扩展管理页面" width="720">
</p>

<p align="center">
  <img src="assets/img/chrome_extend_load.png" alt="Chrome 加载已解压的扩展程序" width="720">
</p>
...
<p align="center">
  <img src="assets/img/open_extension.png" alt="在 Overleaf 页面打开 Chat Overleaf Extended" width="720">
</p>

<p align="center">
  <img src="assets/img/opened_extension.png" alt="Chat Overleaf Extended 侧边栏" width="720">
</p>
...
1. 已经安装并**登录** Codex Desktop 或 Codex CLI。
...
**ChatGPT Web / DeepSeek Web 没有回复或显示API错误怎么办？**

确认对应网页已经登录，并且网页标签页保持打开。可以尝试刷新ChatGPT/DeepSeek网页，然后重新提问。
